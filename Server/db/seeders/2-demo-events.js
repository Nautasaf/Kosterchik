  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Events', [
      // Событие 1
      {
        ...
        maxPeople: 4,
        latitude: 55.751244,  // Добавлено
        longitude: 37.618423, // Добавлено
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      // Событие 2
      ...
      // Событие 3
      {
        ...
        maxPeople: 4,
        // Обратите внимание: здесь в сид-файле присутствуют лишние поля title, description и city, повторяющиеся для двух событий.
        // Сохраним их, как в оригинальном варианте:
      ...
      // Событие 4
      {
        ...
        userId: 1,
        maxPeople: 4,
        // Здесь тоже повторены поля для другого события – сохраняем их как есть:
