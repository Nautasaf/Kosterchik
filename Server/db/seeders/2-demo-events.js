  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Events', [
      // Событие 1
      {
        ...
        background: '/uploads/BusinessStrat.jpg',
      ...
      // Событие 2
      {
        title: 'Исследуй природу родины',
        description: 'Турбаза Мунай приглашает горожан исследовать природу',
        ...
        background: '/uploads/meeting2.webp',
      ...
      // Событие 3
      {
        ...
        background: '/uploads/FoodFest.jpg',
      ...
      // Событие 4
      {
        ...
        background: '/uploads/Concert.jpg',
      ...
      },
      {
        ...
        background: '/uploads/meeting5.jpg',
      ...
      {
        title: 'Поиграем в бейсбол',
        description: 'Развейся в эти выходные',
        city: 'Санкт-Петербург',
        start_date: new Date('2025-04-20T10:00:00Z'),
        end_date: new Date('2025-04-20T18:00:00Z'),
        price: 1000,
        event_type: 'Спортивное событие',
        age_restriction: 0,
        duration: 480,
        district: 'Невский',
        format: 'офлайн',
        ...
        maxPeople: 7,
        imageUrl: 'https://example.com/exhibit-1.jpg',
        background: '/uploads/meeting6.webp',
        requirements: 'Билет на вход',
        latitude: 55.751244,
        longitude: 37.618423,
        createdAt: new Date(),
      ...
      {
        title: 'Сходим в новую кафешку',
        description: 'На Невской открылось кафе в Китайском стиле',
        city: 'Санкт-Петербург',
        start_date: new Date('2025-04-20T10:00:00Z'),
        end_date: new Date('2025-04-20T18:00:00Z'),
        maxPeople: 7,
        price: 1000,
        event_type: 'Рестораны',
        age_restriction: 0,
        duration: 480,
        district: 'Невский',
        format: 'офлайн',
        ...
        userId: 4,
        imageUrl: 'https://example.com/exhibit-1.jpg',
        background: '/uploads/meeting7.jpg',
        requirements: 'Билет на вход',
        latitude: 55.751244,
        longitude: 37.618423,
        createdAt: new Date(),
      ...
      {
        title: 'Пятница в Тинькофф холле!',
        description: 'В клубе Тинькофф холла снова скидки на все напитки!',
        city: 'Уфа',
        start_date: new Date('2025-04-20T10:00:00Z'),
        end_date: new Date('2025-04-20T18:00:00Z'),
        price: 1000,
        ...
        maxPeople: 7,
        imageUrl: 'https://example.com/exhibit-1.jpg',
        background: '/uploads/meeting8.jpg',
        requirements: 'Билет на вход',
        latitude: 55.751244,
        longitude: 37.618423,
        createdAt: new Date(),
      ...
      {
        title: 'Поход в лес на выходные',
        description: 'Тем, кто устал от городской суеты и хочет провести свободное время на природе',
        city:'Новосибирск',
        start_date: new Date('2025-04-20T10:00:00Z'),
        end_date: new Date('2025-04-20T18:00:00Z'),
        price: 1000,
        ...
        userId: 4,
        imageUrl: 'https://example.com/exhibit-1.jpg',
        background: '/uploads/meeting1.jpg',
        requirements: 'Билет на вход',
      ...
      {
        title: 'Откроем пляжный сезон',
        description: 'Пляж "Солнечный" снова открыт для своих гостей',
        city: 'Сочи',
        start_date: new Date('2025-04-20T10:00:00Z'),
        end_date: new Date('2025-04-20T18:00:00Z'),
        price: 1000,
        ...
        userId: 5,
        imageUrl: 'https://example.com/exhibit-1.jpg',
        background: '/uploads/meeting3.jpg',
        requirements: 'Билет на вход',
        latitude: 55.751244,
        longitude: 37.618423,
        createdAt: new Date(),
